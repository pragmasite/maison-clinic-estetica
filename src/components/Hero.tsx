    ...
    <section className="relative min-h-screen overflow-hidden pt-16">
      ...
      <div className="container relative mx-auto flex min-h-screen flex-col items-center justify-center px-4 text-center">
        ...
        <motion.h1
          ...
          className="mb-6 max-w-4xl font-serif text-5xl text-white md:text-6xl lg:text-7xl leading-tight"
        >
          {t.hero.title1}
          <br />
        ...
        >
          ...
          >
            <a href="mailto:info@maisonclinic.com" className="flex items-center gap-2">
